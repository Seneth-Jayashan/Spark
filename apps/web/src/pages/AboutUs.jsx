    ...
    <>
        ...
        <div className="relative z-20 flex flex-col items-center justify-between h-full">
          <div className="flex flex-col items-center justify-center px-10 md:px-40 max-w-7xl mt-24">
            ...
            <motion.p
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              className=" text-center text-xl mt-9 px-5 lg:px-40  "
            >
              We connect passionate people with meaningful causes through the
              power of technology
            </motion.p>
      ...
      <div className="relative bg-white py-10 mx-2 sm:mx-12 md:px-20 overflow-hidden">
        <div className="flex flex-col md:flex-row-3 md:justify-center  md:items-center gap-20 relative z-10">
          ...
          >
            ...
            />
            <div className="p-[1px] rounded-2xl bg-gradient-to-b from-yellow-400 to-blue-500 shadow-xl w-full max-w-xl">
              <div className="rounded-2xl bg-white p-6 h-full text-center">
                ...
                <p className="mt-2 text-gray-600 text-center w-full ">
                  It started with one idea - to make volunteering easier and more impactful
                </p>
      ...
      <div className="py-16 px-6 md:px-28 bg-white text-center overflow-hidden">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto mb-12">
          The principles that guide how we build, collaborate, and serve communities.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="p-[1px] rounded-2xl bg-gradient-to-b from-yellow-400 to-blue-500 shadow-xl"
          >
            <div className="rounded-2xl bg-white p-6 h-full text-center">
              <div className="mx-auto mb-4 h-12 w-12 rounded-full flex items-center justify-center bg-yellow-50">
                <Puzzle className="h-6 w-6 text-yellow-600" />
              </div>
              <h3 className="font-semibold text-lg mb-2">Collaboration</h3>
              <p className="text-gray-600 text-sm">
                We build together to create lasting impact.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-2xl bg-white p-6 h-full text-center">
              <div className="mx-auto mb-4 h-12 w-12 rounded-full flex items-center justify-center bg-blue-50">
                <Lightbulb className="h-6 w-6 text-blue-600" />
              </div>
              <h3 className="font-semibold text-lg mb-2">Innovation</h3>
              <p className="text-gray-600 text-sm">
                We simplify volunteering through smart tools.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-2xl bg-white p-6 h-full text-center">
              ...
              <p className="text-gray-600 text-sm">
                We help organizations and individuals scale good.
              </p>
            </div>
          </motion.div>
      ...
      <div className="py-16 px-6 md:px-32 text-center mt-8 overflow-hidden">
        <div className=" grid lg:grid-cols-2 md:grid-rows-2 gap-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="p-[1px] rounded-2xl bg-gradient-to-b from-yellow-400 to-blue-500 shadow-xl relative"
          >
            <div className="rounded-2xl bg-white p-6 h-full text-center">
            ...
            <div className="p-8">
              ...
              <p className="mt-2">
                Seneth leads our volunteer initiative with a strong passion for
                community service and digital empowerment. With a background in
                software engineering, he ensures the project runs smoothly and
                efficiently. His leadership and dedication inspire the team to
                make a real impact through technology and teamwork.
              </p>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="p-[1px] rounded-2xl bg-gradient-to-b from-yellow-400 to-blue-500 shadow-xl relative max-lg:mt-12"
          >
            <div className="rounded-2xl bg-white p-6 h-full text-center">
            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2">
              <motion.img
            ...
            <div className="p-8">
              ...
              <p className="mt-2">
                Abhishek builds and maintains the technical foundation of our
                website. From coding features to solving bugs, she ensures the
                platform functions perfectly. Her commitment to using technology
                for good helps bring our team’s vision to life.
              </p>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="p-[1px] rounded-2xl bg-gradient-to-b from-yellow-400 to-blue-500 shadow-xl relative mt-12"
          >
            <div className="rounded-2xl bg-white p-6 h-full text-center">
            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2">
              <motion.img
            ...
            <div className="p-8">
              ...
              <p className="mt-2">
                Sajana is responsible for our public communications, community
                connections, and social media presence. He loves storytelling
                and bringing people together for meaningful causes. his creative
                energy keeps our message clear, positive, and inspiring for all
                who visit our platform.
              </p>
          ...
          >
            ...
            <div className="p-8">
              ...
              <p className="mt-2">
                Tharusha designs and refines the visual aspects of our website.
                With a keen eye for detail and a heart for service, he ensures
                every page looks clean, accessible, and welcoming. His goal is
                to make the volunteer experience feel easy and enjoyable for
                everyone.
              </p>
        ...
        >
          <div className="flex flex-col items-center justify-end mr-10 md:mr-28 mt-40 mb-20 w-full max-w-xl ml-auto gap-6  ">
            <motion.h1
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="font-semibold text-4xl text-center text-white "
            >
